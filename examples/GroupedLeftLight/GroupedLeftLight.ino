...
const char* const WLAN_AP_SSID = "WALLLAMP-LEFT";
const char* const WLAN_AP_PASS = "e04c0f83-a133646d2625";
const char* const WLAN_HOSTNAME = "WALLLAMP-LEFT";

const char* const DEVICE_UNIQUE_ID = "WALLLAMP-LEFT";
...
const char* const DISCOVERY_TOPIC = "homeassistant/light/WALLLAMP-LEFT/config";
const char* const AVAIL_STATUS_TOPIC = "homeassistant/light/WALLLAMP-LEFT/status";
const char* const STATE_TOPIC = "homeassistant/light/WALLLAMP-LEFT/state";
const char* const COMMAND_TOPIC = "homeassistant/light/WALLLAMP-LEFT/set";
